<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminGiris.aspx.cs" Inherits="oyunuyorumWebApp.AdminPanel.AdminGiris" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>oyunuYORUM Admin Panel</title>
        ...
        <div class="tasiyici">
            ...
            <div class="icerik">
                ...
                <div class="satir">
                    ...
                    <asp:TextBox ID="tb_kullaniciadi" runat="server" CssClass="metinkutu" placeholder="Kullanıcı Adınız" Text="EnesKabak26"></asp:TextBox>
                </div>
                <div class="satir">
